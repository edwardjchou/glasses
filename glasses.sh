...
python2 $path_FirstAid --pTrain $path_train --pVal $path_val --name $name --pModel $path_model --pLog $path_log --pVis $path_vis --nGPU 0 --bs 8 --ep 50 --nClass 2 --lr 0.001 --do 0.5
